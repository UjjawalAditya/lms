        ...
        <>
            <footer className="bg-white py-5 lg:px-20 px-8 gap-4 w-full flex flex-col md:flex-row lg:flex-row justify-between items-center">
                ...
                <section className='flex items-center justify-center gap-5 text-2xl text-slate-400'>
                    ...
                    <Link to='https://in.linkedin.com/' target='_blank' className='cursor-pointer hover:text-blue-500 transition-all ease-in-out duration-300'><BsLinkedin /></Link>
                    <Link to='https://github.com/AdityaUjjawalThakur' target='_blank' className='cursor-pointer hover:text-blue-500 transition-all ease-in-out duration-300'><BsGithub /></Link>
